  ...
  render() {
    return (
      ...
      <MDBIcon icon='bolt' size='1x' className='blue-text' /> Air Freight</b></h1>
        ...
        <h6>OECL can provide customized sea-air & air-sea options to meet customer’s deadline/timeliness and achieve cost savings. The company handles the airfreight consolidation on many major routes through its efficient worldwide network.</h6>
</MDBCol>
        <MDBCol md='6'>
        <MDBView>
                <img
